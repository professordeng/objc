...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        NSSortDescriptor *pname = [NSSortDescriptor sortDescriptorWithKey:@"name" ascending:YES];
        NSSortDescriptor *pid = [NSSortDescriptor sortDescriptorWithKey:@"ID" ascending:YES];
        
        [ps sortUsingDescriptors:@[pname, pid]];
